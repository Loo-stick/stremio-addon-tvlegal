...
class FranceTVClient {
     ...
     */
    async getDocumentaries(collectionIds = null) {
        const cacheKey = collectionIds ? `docs_${collectionIds.join('_')}` : 'documentaires';

        return cached(cacheKey, async () => {
            console.log(`[FranceTV] Récupération documentaires...`);
